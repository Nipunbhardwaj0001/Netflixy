...
const Header = ({ showProfile = true }) => {
  ...
  return (
    <div className='absolute w-screen px-8 py-2 bg-gradient-to-b from-black flex z-10 justify-between'>
      ...
      <img className="w-12 h-12" alt="usericon" src='https://occ-0-6246-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABTZ2zlLdBVC05fsd2YQAR43J6vB1NAUBOOrxt7oaFATxMhtdzlNZ846H3D8TZzooe2-FT853YVYs8p001KVFYopWi4D4NXM.png?r=229'/>
